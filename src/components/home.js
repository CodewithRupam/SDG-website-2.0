  ...
  return (
    <>
      <div className="main" style={{ backgroundImage: `url(${background})`, borderBottom: '2px solid violet' }}>
        <div className="writing"><br /><br /><br />
          ...
          <div className="buttons" style={{ display: 'flex' }}>
            <form action="/sdg"><motion.button whileHover={{ scale: 1.1 }} whileTap={{scale: 0.9}} className='second_button' style={{width: '170px'}}>SDG 13</motion.button></form>
            <form action='#carbon'><motion.button whileHover={{ scale: 1.1 }} whileTap={{scale: 0.9}} className='second_button' style={{ margin: '0px 25px', width: '170px'}}>carbon footprint</motion.button></form>
          </div>
        </div>
        <div className="img">
      ...
      <div className="second">
        <h1 style={{ textAlign: 'center', color: 'transparent', WebkitTextStroke: '2px orange' }}>Goals</h1><br />

            ...
            <div className="challenge-page"><br /><br />
                ...
                <div className="challenges"><br />
                    <motion.div animate={{ x: 0, y: 0, scale: 1, rotate: 360 }} whileHover={{ scale: 1.1 }} className="challenge"><br />
                        ...
                        <p>objective of the challenge is to encourage individuals or communities to transition to renewable energy solutions to reduce carbon emissions and mitigate climate change.</p>
                        <Link to="/renewable">
                            <button className='btn btn-primary'>Take challenge</button>
                        </Link>
                    </motion.div><br />
                    <motion.div animate={{ x: 0, y: 0, scale: 1, rotate: 360 }} whileHover={{ scale: 1.1 }} className="challenge"><br />
                        <h5>Carbon Footprint Challenge: Reduce, Reuse, Recycle</h5>
                        <p>objective of the challenge is to encourage participants to reduce their carbon footprint through the principles of "reduce, reuse, recycle" and adopt sustainable behaviors.</p>
                        <Link to="/footprint">
                            <button className='btn btn-primary'>Take challenge</button>
                        </Link>
                    </motion.div>
                ...
                <div className="join">
                    ...
                    <ul>
                        ...
                        <li>Share picture of your idea in real life.</li>
                    </ul>
                </div>
            </div>
            <Footer />
